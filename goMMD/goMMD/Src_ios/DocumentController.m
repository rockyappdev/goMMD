...
static NSString *MODELLISTFILENAME = @"__gommd-model.xml";
static NSString *MOTIONLISTFILENAME = @"__gommd-motion.xml";
static NSString *SCENARIOLISTFILENAME = @"__gommd-scenario.xml";
static NSString *SCENARIOGROUPLISTFILENAME = @"__gommd-scenariogroup.xml";
static NSString *MODELGROUPLISTFILENAME = @"__gommd-modelgroup.xml";
static NSString *MOTIONGROUPLISTFILENAME = @"__gommd-motiongroup.xml";
